...
public class SubmitDocumentEntryAddToExistingFolderTest extends ProvideAndRegisterDocumentSetTest{

	@Test
	public void documentEntryAddToExistingFolder(){
		String folderId = submitOneFolder();
		
		DocumentEntry document = metadata.addDocumentToFolder(folderId);
